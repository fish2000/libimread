...
//	if(![[NSFileManager defaultManager] movePath:currpath toPath:newpath handler:nil])
    NSError *err = nil;
    if(![[NSFileManager defaultManager] moveItemAtPath:currpath toPath:newpath error:&err])
	{
...
//	if([ref isRemote]) res=[[NSFileManager defaultManager] removeFileAtPath:path handler:NULL];
    NSError *err = nil;
    if([ref isRemote]) res=[[NSFileManager defaultManager] removeItemAtPath:path error:&err];
...
//        [[NSFileManager defaultManager] removeFileAtPath:destination handler:nil];
        NSError *err = nil;
        [[NSFileManager defaultManager] removeItemAtPath:destination error:&err];
    }

//	if(![[NSFileManager defaultManager] copyPath:currpath toPath:destination handler:nil])
    NSError *err = nil;
    if(![[NSFileManager defaultManager] copyItemAtPath:currpath toPath:destination error:&err])
	{
...
//	if(![[NSFileManager defaultManager] movePath:currpath toPath:destination handler:nil])
    NSError *err = nil;
    if(![[NSFileManager defaultManager] moveItemAtPath:currpath toPath:destination error:&err])
	{
