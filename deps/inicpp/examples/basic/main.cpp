...
std::string get_config() {
    std::string conf_str =
        ...
        "'oPtion 1' and 'Option 1' are different\n"
        "\n"
        "[$Section::subsection]                 ; no subsection, only valid identifier of section\n"
        "Option 2=value 1:value 2:value 3       ; option 'Option 2' is list of 'value 1', 'value "
        "2' and 'value 3'\n"
        "Option 3 =value 1, ${Section 1#Option 1} ; option 'Option 3' is list of 'value 1' and "
        "'value 1'\n"
        "Option 4= v1,${$Section::subsection#Option 3},v2 ; option 'Option 4' is list of 'v1', "
        "'value 1', 'value 1', 'v2'\n"
