...
namespace {
    ...
    using IRGB = im::InterleavedImage<im::color::RGB>;
    using IRGBA = im::InterleavedImage<im::color::RGBA>;
    
    im::fs::TemporaryDirectory td("test-interleaved-io-XXXXX");
    
    TEST_CASE("[interleaved-io] Read PNG files", "[interleaved-read-png]") {
        IRGBA leavedim = im::interleaved::read<im::color::RGBA>(D("roses_512_rrt_srgb.png"));
        IRGBA leavedim2 = im::interleaved::read<im::color::RGBA>(D("marci_512_srgb.png"));
        IRGBA leavedim3 = im::interleaved::read<im::color::RGBA>(D("marci_512_srgb8.png"));
    }
    ...
    TEST_CASE("[interleaved-io] Read JPEG files", "[interleaved-read-jpeg]") {
        IRGBA leavedim = im::interleaved::read<im::color::RGBA>(D("tumblr_mgq73sTl6z1qb9r7fo1_r1_500.jpg"));
        IRGBA leavedim2 = im::interleaved::read<im::color::RGBA>(D("IMG_4332.jpg"));
        IRGBA leavedim3 = im::interleaved::read<im::color::RGBA>(D("IMG_7333.jpeg"));
    }
    ...
    TEST_CASE("[interleaved-io] Read a JPEG and rewrite it as a PNG", "[interleaved-read-jpeg-write-png]") {
        ...
        IRGBA leavedim4 = im::interleaved::read<im::color::RGBA>(D("10954288_342637995941364_1354507656_n.jpg"));
        im::interleaved::write(leavedim4, td.dirpath/"HAY_GUISE.png");
    }
    
    TEST_CASE("[interleaved-io] Read a TIFF", "[interleaved-read-tiff]") {
        IRGBA leavedim = im::interleaved::read<im::color::RGBA>(D("ptlobos.tif"));
    ...
    TEST_CASE("[interleaved-io] Write multiple formats as PPM", "[interleaved-read-tiff-write-ppm]") {
        ...
        IRGBA leavedim2 = im::interleaved::read<im::color::RGBA>(td.dirpath/"PPM_DUG986.ppm");
        im::interleaved::write(leavedim2, td.dirpath/"PPM_YO_DOGG222.png");
        
        IRGBA leavedim3 = im::interleaved::read<im::color::RGBA>(D("tumblr_mgq73sTl6z1qb9r7fo1_r1_500.jpg"));
        im::interleaved::write(leavedim3, td.dirpath/"PPM_OH_DOGGGGG.ppm");
        IRGBA leavedim4 = im::interleaved::read<im::color::RGBA>(td.dirpath/"PPM_OH_DOGGGGG.ppm");
    ...
    TEST_CASE("[interleaved-io] Check the dimensions of a new image", "[interleaved-image-dims]") {
        IRGBA leavedim = im::interleaved::read<im::color::RGBA>(D("tumblr_mgq73sTl6z1qb9r7fo1_r1_500.jpg"));
        IRGBA leavedim2 = im::interleaved::read<im::color::RGBA>(D("marci_512_srgb8.png"));
    }
}